...
IGWOforECM(dim,N,Max_iter,lb,ub,fobj,temp,deltaT,vk,ik,model,z0,iR0)
...
for i=1:size(Positions,1)
    Fit(i) = fobj(Positions(i,:),temp,deltaT,vk,ik,model,z0,iR0); % here
end
...
while iter < Max_iter
    ...
    for i=1:size(Positions,1)
        ...
        Fit_GWO(i) = fobj(X_GWO(i,:),temp,deltaT,vk,ik,model,z0,iR0); % here
    end
    ...
    for t=1:N
        ...
        Fit_DLH(t) = fobj(X_DLH(t,:),temp,deltaT,vk,ik,model,z0,iR0); % here
    end
