% output a OCV for a given SOC value using the average OCV curve
% where the average OCV is the average of charge and discharge OCV
...
function ocv = OCVfromSOCtemp_AVG(soc,temp,model)
if ~isscalar(temp)
